...
const SimilarProducts = () => {
  ...
  // Group products by productId and store name
  const groupedProducts = useMemo(() => {
    ...
    products.forEach((p) => {
      ...
      const storeKey = p.store?.toLowerCase().trim(); // normalize
      if (storeKey) {
            ...
            <div className="overflow-hidden w-full mx-8">
              ...
              >
                {groupedProducts.map((product) => {
                  ...
                  const hasHomeDepot = !!product.stores["home depot"];
                  return (
                    <div
                              ...
                              <div className="flex items-start justify-between">
                                ...
                                <div className="text-right space-y-2">
                                  ...
                                  {hasHomeDepot && (
                                    <div>
                                      <div className="text-lg font-bold text-gray-800">
                                        ${product.stores["home depot"].price}
                                      </div>
                                      {product.stores["home depot"].listPrice >
                                        product.stores["home depot"].price && (
                                        <div className="text-xs text-green-600 font-medium">
                                          Save $
                                          {(
                                            product.stores["home depot"]
                                              .listPrice -
                                            product.stores["home depot"].price
                                          ).toFixed(2)}
                                        </div>
